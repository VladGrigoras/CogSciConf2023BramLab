...
```{r}
v <- c(2:8, 11:17, 20:26, 29:35)
dum <- dum %>%  filter(!row_number() %in% c(1, 9, 10, 18, 19, 27, 28, 36))
...
#move plot 1 test back 
```

- Break down by the objects in rule condition
